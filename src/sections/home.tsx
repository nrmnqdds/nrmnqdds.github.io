	...
	return (
		<section id="home" className="h-screen overflow-hidden relative">
			<div className="absolute flex flex-col md:flex-row items-center justify-center w-full h-full">
				...
				<div className="md:flex-1 flex items-center justify-center overflow-hidden h-screen">
					<motion.div
					...
					>
						<Image
							...
							width={300}
							height={300}
							className="pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-black to-gray-300/80 bg-clip-text text-center text-8xl font-semibold leading-none text-transparent dark:from-white dark:to-slate-900/10 object-contain"
						/>

						{/* Inner Circles */}
						<OrbitingCircles
							className="h-[30px] w-[30px] border-none bg-transparent overflow-hidden"
							duration={20}
							delay={20}
							radius={80}
						>
